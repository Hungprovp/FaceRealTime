...
class FaceTrainer:
    ...
    def __init__(self):
        self.dataset_train = "D:/Hieu/RealTimeFaceRecognition/faces_dataset/train/"
        self.dataset_val = "D:/Hieu/RealTimeFaceRecognition/faces_dataset/val/"
        return
    ...
    def create_faces_npz(self):
        ...
        savez_compressed('faces_dataset', trainX, trainy, testX, testy)
        return
    ...
    def create_faces_embedding_npz(self):
        ...
        # save arrays to one file in compressed format
        savez_compressed('faces_dataset_embeddings', newTrainX, trainy, newTestX, testy)
        return
    ...
    def classifier(self):
        ...
        # load dataset
        data = load('faces_dataset_embeddings.npz')
        trainX, trainy, testX, testy = data['arr_0'], data['arr_1'], data['arr_2'], data['arr_3']
        ...
        pickle.dump(model, open('SVM_classifier.sav', 'wb'))
        # predict
